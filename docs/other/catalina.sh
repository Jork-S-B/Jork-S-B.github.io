...
JAVA_OPTS='-Xms1024m -Xmx1024m -XX:PermSize=128m  -XX:MaxPermSize=256m -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/usr/local/apache/Tomcat7-8083/bin/dushi.hprof
           -Djava.rmi.server.hostname=192.168.32.136
